...
import { addMovie, liked, unliked } from "../Redux/features/movie/MovieSlice";
      ...
      {movieData.map((data) => {
        ...
        return (
          ...
          >
            ...
            <i
              className="fas fa-heart px-4 py-2 mt-auto text-white w-8 h-8 cursor-pointer "
              onClick={() => handleLike(data)} onDoubleClick={()=>dispatch(unliked(data))}
            ></i>
